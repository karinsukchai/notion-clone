...
export const Navigation = () => {
  ...
  const navbarRef = useRef<HTMLElementTagNameMap["div"]>(null);
    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          isResetting && "transition-all w-full ease-in-out duration-300",
          ...
          <nav className="bg-transparent px-3 py-2 w-full">
            {isCollapsed && (
              <MenuIcon
                onClick={resetWidth}
                role="button"
                className="cursor-pointer w-6 h-6 text-muted-foreground"
              />
            )}
          </nav>
        )}
